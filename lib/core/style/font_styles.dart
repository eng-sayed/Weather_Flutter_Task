...
class TextStyles {
  ...
  static TextStyle? _cachedFont14BlackRegular;
  ...
  static TextStyle get font14BlackRegular {
    _cachedFont14BlackRegular ??= const TextStyle(
      fontSize: 14,
      fontWeight: FontWeights.regular,
      color: Colors.black,
      fontFamily: AppFonts.defaultFont,
    );
    return _cachedFont14BlackRegular!;
  }
  ...
  static TextStyle get font20blackSemiBold {
  ...
  static void refresh() {
    ...
    _cachedFont14BlackRegular = null;
